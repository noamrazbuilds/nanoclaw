...
export interface ContainerConfigRow {
  ...
  allow_model_delegation: number; // 0|1 — C4: may a scheduled task override the model? (migration 016)
  ...
  packages_pip: string; // JSON: string[] (F3 — Python pip deps for the per-group image)
